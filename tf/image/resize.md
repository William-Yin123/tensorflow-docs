...
<a href="../../tf/image/ResizeMethod.md#NEAREST_NEIGHBOR"><code>ResizeMethod.NEAREST_NEIGHBOR</code></a>. Otherwise, the return value has type
`float32`.
...
* <b>`ValueError`</b>: if `size` has an invalid shape or type.
